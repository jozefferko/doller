...
csvs = os.path.join(current_directory, 'CSVs')
data_path = os.path.join(csvs, 'Ladder machine 1.csv')
path_out = os.path.join(csvs, 'output.csv')
prod_table = pd.read_csv(os.path.join(csvs, 'ProdTable.csv'), sep=';', encoding="ISO-8859-1")
work_table = pd.read_csv(os.path.join(csvs, 'JmgStampTrans.csv'), sep=';', encoding="ISO-8859-1")

orig_data = dc.clean_csv(data_path, path_out)
filtered = dc.filter_raw_work_table(work_table, prod_table, 1405, '^CF|^SW')
